...
to update-turtles
  ask turtles [
    ...
    set happy? (similar-nearby >= (%-similar-wanted * total-nearby / 100)) and (similar-nearby <= (%-similar-maximo * total-nearby / 100))
...
<experiments>
  <experiment name="experiment1" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="%-similar-maximo">
      <value value="100"/>
    </enumeratedValueSet>
  ...
  <experiment name="experiment2" repetitions="10" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="density" first="80" step="1" last="99"/>
    <steppedValueSet variable="%-similar-wanted" first="10" step="1" last="60"/>
  </experiment>
  <experiment name="experiment3" repetitions="10" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="%-similar-wanted" first="0" step="1" last="30"/>
    <steppedValueSet variable="%-similar-maximo" first="60" step="1" last="90"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@

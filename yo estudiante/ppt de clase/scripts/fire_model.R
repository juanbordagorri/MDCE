...
# gráfico con el porcentaje quemado en relación a la densidad 
plot(res$density,res$burned,xlab="densidad",ylab="% quemado", main="Experimento 1",type="b")

## pregunta: ¿en dónde se encuentra el tipping point?
...
res <- fire_2 %>%
  ...
  # gráfico con el porcentaje quemado en realción a la densidad 
...
## Dónde encontramos el tipping point? depende de ambas variables?
